    ...
    <div className="container max-w-3xl mx-auto">
      ...
      <div className="sticky bottom-0 bg-background z-10 p-4 border-t">
        <div className="flex space-x-4">
          <Button className="flex-1 py-6" variant="secondary" onClick={() => window.history.back()}>
            이전 화면으로 돌아가기
          </Button>
          <Button className="flex-1 py-6" onClick={handleSubmit} disabled={isSubmitting || isLoading}>
